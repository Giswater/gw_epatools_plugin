...
from ...settings import tools_qgis, tools_qt, tools_gw, tools_db, tools_os, tools_log, task, get_giswater_folder
...
class GwRecursiveEpa(task.GwTask):
    ...
    def __init__(self, description, prefix, path, settings, plugin_dir):
        ...
        self.fid = 140
        self.plugin_dir = get_giswater_folder(get_full_path=True)
        self.stop = False
        self.t0 = 0
