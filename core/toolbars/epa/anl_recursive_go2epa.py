...
class RecursiveEpa():
    ...
    def clicked_event(self):
        ...
        # Load user values
        last_config_path = tools_gw.get_config_parser('recursive_epa', 'config_path', 'user', 'session', plugin=global_vars.user_folder_name)
    ...
    def save_user_values(self, dialog):
        ...
        tools_gw.set_config_parser('recursive_epa', 'config_path', f"{config_path}", plugin=global_vars.user_folder_name)
